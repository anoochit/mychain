...
@$core.Deprecated('Use merkelRoolDescriptor instead')
const MerkelRool$json = const {
  '1': 'MerkelRool',
  '2': const [
...
/// Descriptor for `MerkelRool`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List merkelRoolDescriptor = $convert.base64Decode('CgpNZXJrZWxSb29sEhIKBGhhc2gYASABKAlSBGhhc2g=');
...
const ConsensusState$json = const {
  ...
  '2': const [
    ...
    const {'1': 'root', '3': 3, '4': 1, '5': 11, '6': '.tendermint.spn.types.MerkelRool', '8': const {}, '10': 'root'},
  ],
};

/// Descriptor for `ConsensusState`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List consensusStateDescriptor = $convert.base64Decode('Cg5Db25zZW5zdXNTdGF0ZRIuChJuZXh0VmFsaWRhdG9yc0hhc2gYASABKAlSEm5leHRWYWxpZGF0b3JzSGFzaBIcCgl0aW1lc3RhbXAYAiABKAlSCXRpbWVzdGFtcBI6CgRyb290GAMgASgLMiAudGVuZGVybWludC5zcG4udHlwZXMuTWVya2VsUm9vbEIEyN4fAFIEcm9vdA==');
