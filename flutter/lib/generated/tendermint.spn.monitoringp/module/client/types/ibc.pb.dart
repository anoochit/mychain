...
class MerkelRool extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MerkelRool', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.spn.types'), createEmptyInstance: create)
  ...
  factory MerkelRool.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory MerkelRool.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  MerkelRool clone() => MerkelRool()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MerkelRool copyWith(void Function(MerkelRool) updates) => super.copyWith((message) => updates(message as MerkelRool)) as MerkelRool; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static MerkelRool create() => MerkelRool._();
  MerkelRool createEmptyInstance() => create();
  static $pb.PbList<MerkelRool> createRepeated() => $pb.PbList<MerkelRool>();
  @$core.pragma('dart2js:noInline')
  static MerkelRool getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MerkelRool>(create);
  static MerkelRool? _defaultInstance;
...
class ConsensusState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConsensusState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.spn.types'), createEmptyInstance: create)
    ...
    ..aOM<MerkelRool>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'root', subBuilder: MerkelRool.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  MerkelRool get root => $_getN(2);
  @$pb.TagNumber(3)
  set root(MerkelRool v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRoot() => $_has(2);
  @$pb.TagNumber(3)
  void clearRoot() => clearField(3);
  @$pb.TagNumber(3)
  MerkelRool ensureRoot() => $_ensure(2);
}
